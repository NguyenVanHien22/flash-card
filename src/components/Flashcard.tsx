    ...
    <div className="w-full max-w-3xl mx-auto">      
        ...
        >
          ...
          <div className="absolute w-full h-full backface-hidden bg-white rounded-xl shadow-lg p-8 flex flex-col overflow-y-auto">
            <div className="flex-grow flex flex-col">
              <div className="text-sm text-pink-pastel mb-2">Module {question.moduleId}</div>
      ...
      <div className="mt-8 flex justify-center gap-4">
        ...
        <button
          ...
          className={`px-6 py-3 bg-pink-pastel text-white rounded-lg transition-colors flex items-center gap-2 ${
            current === total - 1 || isTransitioning
              ? 'opacity-50 cursor-not-allowed'
              : 'hover:bg-pink-pastel-hover'
          }`}
        >
          Next
